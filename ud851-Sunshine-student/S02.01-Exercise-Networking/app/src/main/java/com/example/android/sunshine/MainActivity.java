...
public class MainActivity extends AppCompatActivity {
    ...
    void loadWeatherData() {
        URL openWeatherSearchUrl = NetworkUtils.buildUrl("94043,USA");
        new FetchWeatherTask().execute(openWeatherSearchUrl);
    }
    ...
    public class FetchWeatherTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            ...
            String openWeatherSearchResults = null;
            try {
                openWeatherSearchResults = NetworkUtils.getResponseFromHttpUrl(searchUrls);
            } catch (IOException e) {
                e.printStackTrace();
            }
            return openWeatherSearchResults;
        }
